...
- Data UTC: `2026-05-10T08:11:29.394936+00:00`
...
1. **llama3.2:latest** - quality_avg=61.4, policy=82.0%, hallucination_risk=0.0%, avg_latency=206 ms, avg_ttft=95 ms

## Compatibilita realtime (latenza)

- **llama3.2:latest**: avg=206 ms, p95=288 ms, avg_ttft=95 ms, p95_ttft=100 ms, profilo=realtime_ready, compatibile=True. Motivo: Tempo prima risposta e latenza totale entro target realtime.

## Ranking combinato qualita e latenza

1. **llama3.2:latest** - combined=0.729, quality_avg=61.4, avg_latency=206 ms, avg_ttft=95 ms, policy=82.0%
